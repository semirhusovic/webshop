            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <aside class="md:w-1/4">
                    ...
                    <article class="border border-gray-200 bg-white shadow-sm rounded mb-5 p-3 lg:p-5">
                        ...
                        <a class="px-4 py-3 mb-2 inline-block text-lg w-full text-center font-medium text-white bg-teal-400 border border-transparent rounded-md hover:bg-teal-600" href="#"> Checkout </a>

                        <a class="px-4 py-3 inline-block text-lg w-full text-center font-medium text-teal-400 bg-white shadow-sm border border-gray-200 rounded-md hover:bg-gray-100" href="#"> Back to shop </a>
