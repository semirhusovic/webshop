...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/accordition.css')}}"/>
...
>
    ...
    >
        <div class="py-4 text-gray-500 dark:text-gray-400">
            ...
            <ul>
                <li class="relative px-6 py-3">
                    @if(str_contains(Route::currentRouteName(),'slider'))
                        <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                              aria-hidden="true"></span>
                    @endif
                    <a
                ...
                <li class="relative px-6 py-3">
                    @if(str_contains(Route::currentRouteName(),'country'))
                        <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                              aria-hidden="true"></span>
                    @endif
                    <a
                ...
                <li class="relative px-6 py-3">
                    @if(str_contains(Route::currentRouteName(),'category'))
                        <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                              aria-hidden="true"></span>
                    @endif
                    <a
                ...
                <li class="relative px-6 py-3">
                    @if(str_contains(Route::currentRouteName(),'promotion'))
                        <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                              aria-hidden="true"></span>
                    @endif
                    <a
                ...
                <li class="relative px-6 py-3">
                    @if(str_contains(Route::currentRouteName(),'discount'))
                        <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                              aria-hidden="true"></span>
                    @endif
                    <a
                ...
                <li class="relative px-6 py-3">
                    @if(str_contains(Route::currentRouteName(),'manufacturer'))
                        <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                              aria-hidden="true"></span>
                    @endif
                    <a
                    ...
                    >
                        ...
                        <span class="ml-4">Manufacturer</span>
                    </a>
                </li>
                            ...
                            >
                                ...
                                <li class="flex">
                                    ...
                                    > @csrf
                                        ...
                                        <button class="font-semibold"><span>Log out</span></button>
                                    </form>
                                </li>
                            </ul>
                        </template>
